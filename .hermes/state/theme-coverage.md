...
| neovim | T | kanagawa.nvim wave + hl_overrides via palette.lua | awaiting user test (4.3) | 4 |
...
Next: 4.3 — user runs `:Lazy sync` then `:Lazy clean` in nvim on vkokurin AND crookedmirror, then the 4.3 checklist.
Blocked on: nothing.
