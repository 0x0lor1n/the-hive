...
static const Key keys[] = {
	 ...
	 * window is a tmux client, and Super+Shift+Return / Ctrl+Shift+Return are
	 * tmux's split-window (foot text-bindings encode both as CSI 13;6u). The
	 * compositor must let them through; a new window is Super+Alt+T below. */
	...
	{ 0, XKB_KEY_XF86AudioRaiseVolume,  spawn, SHCMD("volumectl -d -u up") },
	{ 0, XKB_KEY_XF86AudioLowerVolume,  spawn, SHCMD("volumectl -d -u down") },
	{ 0, XKB_KEY_XF86AudioMute,         spawn, SHCMD("volumectl -d toggle-mute") },
	...
	{ 0, XKB_KEY_XF86MonBrightnessUp,   spawn, SHCMD("lightctl -d up") },
	{ 0, XKB_KEY_XF86MonBrightnessDown, spawn, SHCMD("lightctl -d down") },
