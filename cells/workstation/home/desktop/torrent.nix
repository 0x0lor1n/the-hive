...
# ~/.local/share/qBittorrent (BT_backup resume data, logs).
{
  ...
  colors = {
    ...
    "TransferList.Downloading" = h c.springGreen;
    "TransferList.StalledDownloading" = h c.autumnGreen;
    "TransferList.DownloadingMetadata" = h c.springGreen;
    "TransferList.ForcedDownloadingMetadata" = h c.springGreen;
    "TransferList.ForcedDownloading" = h c.springGreen;
    "TransferList.Uploading" = h c.springBlue;
    "TransferList.StalledUploading" = h c.dragonBlue;
    "TransferList.ForcedUploading" = h c.springBlue;
    "TransferList.QueuedDownloading" = h c.carpYellow;
    "TransferList.QueuedUploading" = h c.carpYellow;
    ...
    "TransferList.StoppedUploading" = h c.oniViolet;
